...
In an accelerated time model, I mistakenly said that k is labeled as the scale parameter. That was close, but not quite accurate.
...
## SAS is consistent with R, inconsistent with my faulty interpretation
...
The scale parameter in a Weibull accelerated time model is not k, it is 1/k. So the accelerated time model for the Weibull distribution is

$S(t,\sigma,\beta_0,\beta_1) = e^{-(\frac{t}{e^{\beta_0+\beta_1X}})^{\frac{1}{\sigma}}$ 
